...
Citizen.CreateThread(function()
    ...
    RegisterCommand("clearchat", function()
        ...
        TriggerEvent("chatMessage", "[Info] Ti ai sters chat-ul.")
    end)
...
RegisterNUICallback('chatResult', function(data, cb)
    ...
    if theMessage:sub(1, 1) == '/' then
      ...
      TriggerServerEvent('chat:messageEntered', GetPlayerName(id), theMessage)
    end
...
RegisterNetEvent("plesPeds:set")
AddEventHandler("plesPeds:set", function(pedModel)
