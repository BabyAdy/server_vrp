-- ==========================================================
--  Lista de vehicule VANILLA folosita de /faction seedvanilla
--  Format: { model = 'spawnname', label = 'Nume afisat' }
--  Editeaza / extinde liber.  Cand adaugi vehicule CUSTOM, adauga-le
--  in `faction_vehicles` (prin meniu / /faddveh) - nu aici.
-- ==========================================================
return {
    car = {
        -- compacts / sedans
